module RestfulController
  ...
  def self.included( klass )
    ...
    klass.before_filter :prepare_restful_controller_method
  ...
  def prepare_restful_controller_method
    ...
    when :plural
      self.action_name = request.request_method.to_s.pluralize.to_sym
    when :singular
      self.action_name = request.request_method.to_s.singularize.to_sym
    end
  end
